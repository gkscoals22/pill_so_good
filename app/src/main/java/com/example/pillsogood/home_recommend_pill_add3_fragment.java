...
public class home_recommend_pill_add3_fragment extends Fragment{
    private View view;
    ...
    public static home_recommend_pill_add3_fragment newInstance() {
        return new home_recommend_pill_add3_fragment();
    }
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.home_recommend_pill_add3, container, false);
